// Custom GraphQL middleware with support for replacing the schema and rootNode
// Copy from express-graphql node module
// Still requires express-graphql to be loaded
'use strict';
...
var _parseBody = require('express-graphql/dist/parseBody');

var _renderGraphiQL = require('express-graphql/dist/renderGraphiQL');
...
function graphqlHTTP(options) {
  ...
  var middlewarefunction = function graphqlMiddleware(request, response) {
    ...
    return getGraphQLParams(request).then(function (graphQLParams) {
      ...
      middlewarefunction.schema = schema;
