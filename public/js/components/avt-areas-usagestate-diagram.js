app.directive('avtAreasUsagestateDiagram', function (utils) {
    ...
    return {
        ...
        compile: (element) => {
            ...
            element.removeAttr("avt-areas-usagestate-diagram");
            ...
            return (scope) => {
                scope.load = async() => {
                    ...
                    for (var i = 0; i < scope.usagestates.length; i++) {
                        var us = scope.usagestates[i];
                        data.push(us.f);
