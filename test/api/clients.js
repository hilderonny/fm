...
describe('API clients', async() => {
    ...
    describe('GET/:id', async() => {
        ...
        function checkForUser(user) {
            return async() => {
                await th.removeClientModule("client0", "clients");
                var token = await th.defaults.login("client0_usergroup0_user0");
                await th.get(`/api/clients/client0?token=${token}`).expect(403);
            }
        }
    ...
    describe('POST/', async() => {
        ...
        th.apiTests.post.defaultNegative(co.apis.clients, co.permissions.ADMINISTRATION_CLIENT, createPostTestElement);
    ...
    describe('POST/newadmin', async() => {
        ...
        th.apiTests.post.defaultNegative(co.apis.clients + "/newAdmin", co.permissions.ADMINISTRATION_CLIENT, createPostNewAdminTestElement);
    ...
    describe('PUT/:id', async() => {
        ...
        th.apiTests.put.defaultNegative(co.apis.clients, co.permissions.ADMINISTRATION_CLIENT, createPutTestElement);
